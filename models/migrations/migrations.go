...
func prepareMigrationTasks() []*migration {
	...
	preparedMigrations = []*migration{
		...
		newMigration(312, "Add MemberToSet and SetToSet tables", v1_24.AddPermissionSetsTable),
		newMigration(313, "Add MemberToSet and SetToSet tables", v1_24.AddPermissionSetsTable),
	}
	return preparedMigrations
}
